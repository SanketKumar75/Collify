        ...
        <div>
                     ...
                     <div className="card-header bg-secondary border rounded d-flex justify-content-between">
                        ...
                        <button className="bg-dark border rounded h-5  text-light"  > 
                            <NavLink className="nav-link text-light" to="/student/login" onClick={(e)=> {window.alert("Successfully logged out")}}>logout</NavLink></button>
            ...
            <div className="Options Content">
                        ...
                        <NavLink className="nav-link col text-secondry bg-light  border rounded " to="/student/disscussion"><div className="Option text-dark"><h5>Discussion</h5></div></NavLink>
